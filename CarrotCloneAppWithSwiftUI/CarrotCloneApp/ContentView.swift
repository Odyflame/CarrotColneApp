    ...
    var body: some View {
        TabView(selection: $selection,
                content:  {
                    ...
                    Text("Tab Content 2").tabItem { Label("동네생활", systemImage: "list.and.film") }.tag(Tab.life)
                    NearbyView().tabItem { Label("내 근처", systemImage: "location.viewfinder") }.tag(Tab.nearby)
                    Text("Tab Content 4").tabItem { Label("채팅", systemImage: "arrow.up.message") }.tag(Tab.chat)
